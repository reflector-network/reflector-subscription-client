...
export default class ContractClient extends contract.Client {
    ...
    constructor(options) {
        super(new contract.Spec([
            ...
            //"AAAAAQAAAAAAAAAAAAAADkNvbnRyYWN0Q29uZmlnAAAAAAADAAAAAAAAAAVhZG1pbgAAAAAAABMAAAAAAAAAA2ZlZQAAAAAGAAAAAAAAAAV0b2tlbgAAAAAAABM=", //ContractConfig
            ...
            //"AAAAAAAAAAAAAAAGY29uZmlnAAAAAAABAAAAAAAAAAZjb25maWcAAAAAB9AAAAAOQ29udHJhY3RDb25maWcAAAAAAAA=", //config()
            //"AAAAAAAAAAAAAAAHc2V0X2ZlZQAAAAABAAAAAAAAAANmZWUAAAAABgAAAAA=", //set_fee(),
            //"AAAAAAAAAAAAAAAHdHJpZ2dlcgAAAAACAAAAAAAAAAl0aW1lc3RhbXAAAAAAAAAGAAAAAAAAAAx0cmlnZ2VyX2hhc2gAAAPuAAAAIAAAAAA=", //trigger()
            //"AAAAAAAAAAAAAAAGY2hhcmdlAAAAAAABAAAAAAAAABBzdWJzY3JpcHRpb25faWRzAAAD6gAAAAYAAAAA", //charge()
            //"AAAAAAAAAAAAAAAPdXBkYXRlX2NvbnRyYWN0AAAAAAEAAAAAAAAACXdhc21faGFzaAAAAAAAA+4AAAAgAAAAAA==", //update_contract()
            ...
            //"AAAAAAAAAAAAAAAHbGFzdF9pZAAAAAAAAAAAAQAAAAY=", //last_id()
            //"AAAAAAAAAAAAAAAFYWRtaW4AAAAAAAAAAAAAAQAAA+gAAAAT", //admin()
